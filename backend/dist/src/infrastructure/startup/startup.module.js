...
const startup_safety_service_1 = require("./startup-safety.service");
let StartupModule = class StartupModule {
};
exports.StartupModule = StartupModule;
exports.StartupModule = StartupModule = __decorate([
    (0, common_1.Module)({
        providers: [startup_safety_service_1.StartupSafetyService],
        exports: [startup_safety_service_1.StartupSafetyService],
    })
], StartupModule);
